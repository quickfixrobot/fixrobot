...
class Test_Class:
    ...
    def test_NewOrderSingleFilled_AsStrings_ShouldPass(self, setUpFIX50ClientAndExchange):
        ...
        time.sleep(1)
        self.exch.receiveMessage("LogonPass")
        time.sleep(1)
        self.client.receiveMessage("LogonPass")
        ...
        returnMessageAcceptor = self.exch.sendMessage(
            "ExecutionReport", "|35=8|$setField( ClOrdID,  IN, ClOrdID )|$setField( OrderID )|$setField( ExecID )|150=0|39=0|55=MSFT|38=100|54=1|44=10.50|151=100|14=0|")
        if returnMessageAcceptor:
        ...
        time.sleep(1)
        returnMessageAcceptor = self.exch.sendMessage(
            "ExecutionReport", "|35=8|$setField( ClOrdID,  IN, ClOrdID )|$setField( OrderID )|$setField( ExecID )|150=F|39=2|55=MSFT|38=100|54=1|44=10.50|32=100|31=10.50|151=0|14=100|6=10.50|")
        if returnMessageAcceptor:
            assert returnMessageAcceptor.getHeader().getField(35) == "8"
        time.sleep(1)
        returnMessageInitiator = self.client.receiveMessage(
